export const messages = {
    please_connect: "Please connect your wallet to the Avalanche network to use SpicyDAO.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} SPC.`,
