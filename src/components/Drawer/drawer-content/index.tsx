    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://spcdao.co" target="_blank" style={{textAlign:"center"}}>
                    <img alt="" src={WonderlandIcon} width={130}/>
                    <div className="wallet-link-title">Spicy Dao</div>
                </Link>
            ...
            <div className="dapp-menu-links">
                <div className="dapp-nav">
                    ...
                    <Link href="https://spcdao.gitbook.io/spcdao/" target="_blank" className={classnames("button-dapp-menu", { active: isActive })}>
                        <div className="dapp-menu-item">
